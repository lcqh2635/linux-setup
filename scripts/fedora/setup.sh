...
# 定义加速前缀 (可自行更换)
GITHUB_PROXY_URL="https://wget.la/"

# 候选代理列表 (请根据实际情况更新，失效的及时移除)
# 格式： "显示名称|URL前缀"
PROXIES=(
    git clone --depth=1 https://gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev.git
    wget "https://gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.4.7/Clash.Verge-2.4.7-1.x86_64.rpm"
    git clone --depth=1 https://hk.gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev.git
    wget "https://hk.gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.4.7/Clash.Verge-2.4.7-1.x86_64.rpm"
    git clone --depth=1 https://cdn.gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev.git
    wget "https://cdn.gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.4.7/Clash.Verge-2.4.7-1.x86_64.rpm"
    git clone --depth=1 https://edgeone.gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev.git
    wget "https://edgeone.gh-proxy.org/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.4.7/Clash.Verge-2.4.7-1.x86_64.rpm"
    
    git clone --depth=1 https://wget.la/https://github.com/clash-verge-rev/clash-verge-rev.git
    wget "https://wget.la/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.4.7/Clash.Verge-2.4.7-1.x86_64.rpm"
    git clone --depth=1 https://gh.jasonzeng.dev/https://github.com/clash-verge-rev/clash-verge-rev.git
    wget "https://gh.jasonzeng.dev/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.4.7/Clash.Verge-2.4.7-1.x86_64.rpm"
    git clone --depth=1 https://ghproxy.cxkpro.top/https://github.com/clash-verge-rev/clash-verge-rev.git
    wget "https://ghproxy.cxkpro.top/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.4.7/Clash.Verge-2.4.7-1.x86_64.rpm"
    git clone --depth=1 https://gh.monlor.com/https://github.com/clash-verge-rev/clash-verge-rev.git
    wget "https://gh.monlor.com/https://github.com/clash-verge-rev/clash-verge-rev/releases/download/v2.4.7/Clash.Verge-2.4.7-1.x86_64.rpm"
)
